...
shippingpage.selectShippingAddress("test@gmail.com", "Tuan", "Nguyen", "FPT", "26/2/89 Ngo Quyen", "NewYork", "99999", "0909090909", "Alaska", "United States")
//shippingpage.selectShippingMethod("flat rate")
shippingpage.selectShippingMethod("best way")
shippingpage.clickNextBtn()
//shippingpage.verifyOrderTotalPrice('$119.00')
shippingpage.verifyOrderTotalPrice('$109.00')
